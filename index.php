...
// * - создаем функцию которая считает колличетво наших постов (через счетчик считаем колличество строк в файле)
    function PostCount()
    {
        $count = 0;
...
<div class="container">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <!-- вставляем наш php для вывода информации -->
            <?php display(); ?>

            <!-- * - навигационное меню и вставляем наш php для вывода пагинации -->
            <nav>
                <ul class="pagination">
